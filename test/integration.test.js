...
describe('Routes', function() {
  ...
  it('should respond with http 200 and empty json on POST /secret/set', function(done) {
    supertest.post('/secret/set')
      .type('form')
  ...
  it('should respond with http 403 on /secret/set if token verification failed', function(done) {
    supertest.post('/secret/set')
    .type('form')
  ...
  it('should respond with http 403 on /secret/get if token verification failed', function(done) {
    supertest.post('/secret/get')
    .type('form')
...
describe('Route /secret/get', function() {
  beforeEach(function() {
    require('../src/app')(app, redisService);
    supertest = require('supertest')(app);
    nock.enableNetConnect();
